<x-app-layout>
        <div x-data="{ imageSrc: '/images/userImage.jpg' }" class="relative background-container">
            ...
            <div class="w-2/4 p-4 space-y-4 sidebar">
                <a href="http://conectasalud.batoi.es" @mouseover="imageSrc = '/images/userImage.jpg'" class="link">Usuarios</a>
                ...
                <a href="llamadas" @mouseover="imageSrc = '/images/ModifiUser.jpg'" class="link">Llamadas</a>
            </div>
        </div>
</x-app-layout>
